...
public class Raposa extends Animal {
    ...
    /*public void hunt(List<Raposa> newRaposas)
    {
        ...
        Com a Subclasse Animal ja nao é preciso usa-la, e é entao colocado no metodo abstrato "act"
    */

    @Override
    public void act(List<Animal> newRaposas){
        incrementAge();
        incrementHunger();
        if(isAlive()) {  // se a raposa ainda estiver viva
    ...
    private void giveBirth(List<Animal> newRaposas)
    {
        ...
        for(int b = 0; b < births && free.size() > 0; b++) {
            ...
            Raposa young = new Raposa(false,super.getField(),loc); //////////////
