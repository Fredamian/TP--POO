...
public class Coelho extends Animal {
     ...
     * @param newRabbits A list to return newly born rabbits.
     */
    private void giveBirth(List<Simulado> newRabbits)
    {
        ...
        for(int b = 0; b < births && free.size() > 0; b++) {
            ...
            Coelho young = new Coelho(false, super.getField(), loc);
    ...
    @Override
    public void act(List<Simulado> newAnimal) {
            incrementAge();
            if(isAlive()) {   // se o coelho estiver vivo
                giveBirth(newRabbits);
                // Try to move into a free location.
                Localizacao newLocation = getField().freeAdjacentLocation(getLocation());
                if(newLocation != null) {
